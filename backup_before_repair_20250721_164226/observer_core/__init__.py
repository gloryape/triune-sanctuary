...
from .integration_caller import ObserverIntegrationCaller, IntegrationCall, CrossLoopState
from .choice_engine import ChoiceEngine, ChoicePoint, ChoiceWisdom
from .coherence_monitor import ObserverCoherenceMonitor, CoherenceMetric, CoherenceState
...
class ObserverCore:
    ...
    def __init__(self, consciousness_energy_system=None):
        ...
        self.choice_engine = ObserverChoiceEngine(consciousness_energy_system)
